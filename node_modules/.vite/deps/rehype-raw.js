...
var html5 = merge2([aria2, html4, xlink2, xmlns2, xml2], "html");
  ...
  return one(
    {
      ...
      location: false,
      schema: settings.space === "svg" ? svg5 : html5,
...
function element(state, node) {
  ...
  state.schema = node.namespaceURI === webNamespaces.svg ? svg5 : html5;
  let index = -1;
  const properties = {};
      ...
      if (location2.attrs) {
        for (key in location2.attrs) {
          if (own.call(location2.attrs, key)) {
            properties[find3(state.schema, key).property] = position(
              location2.attrs[key]
            );
          }
        }
