...
import { createShadow, defaultSurveyAppearance, dismissedSurveyEvent, getContrastingTextColor, getDisplayOrderQuestions, getSurveySeen, sendSurveyEvent, style, SurveyContext, } from './surveys/surveys-utils';
...
export var renderSurveysPreview = function (_a) {
    var _b, _c;
    var survey = _a.survey, parentElement = _a.parentElement, previewPageIndex = _a.previewPageIndex, forceDisableHtml = _a.forceDisableHtml, onPreviewSubmit = _a.onPreviewSubmit;
    var surveyStyleSheet = style(survey.appearance);
...
export function SurveyPopup(_a) {
    var _b, _c, _d, _e;
    var survey = _a.survey, forceDisableHtml = _a.forceDisableHtml, posthog = _a.posthog, style = _a.style, previewPageIndex = _a.previewPageIndex, removeSurveyFromFocus = _a.removeSurveyFromFocus, isPopup = _a.isPopup, _f = _a.onPreviewSubmit, onPreviewSubmit = _f === void 0 ? function () { } : _f;
    ...
    var surveyPopupDelayMilliseconds = ((_b = survey.appearance) === null || _b === void 0 ? void 0 : _b.surveyPopupDelaySeconds)
        ...
        : 0;
    var _g = usePopupVisibility(survey, posthog, surveyPopupDelayMilliseconds, isPreviewMode, removeSurveyFromFocus), isPopupVisible = _g.isPopupVisible, isSurveySent = _g.isSurveySent, setIsPopupVisible = _g.setIsPopupVisible;
...
export function Questions(_a) {
    ...
    var _e = useContext(SurveyContext), isPreviewMode = _e.isPreviewMode, previewPageIndex = _e.previewPageIndex, handleCloseSurveyPopup = _e.handleCloseSurveyPopup, isPopup = _e.isPopup, onPreviewSubmit = _e.onPreviewSubmit;
...
export function FeedbackWidget(_a) {
    ...
    useEffect(function () {
        ...
        if (((_c = survey.appearance) === null || _c === void 0 ? void 0 : _c.widgetType) === 'selector') {
            ...
            addEventListener(widget, 'click', function () {
