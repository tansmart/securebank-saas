...
var generateSessionSourceParams = function (instance) {
    var config = instance === null || instance === void 0 ? void 0 : instance.config;
    return __assign({ initialPathName: (location === null || location === void 0 ? void 0 : location.pathname) || '', referringDomain: Info.referringDomain() }, Info.campaignParams({
        customTrackedParams: config === null || config === void 0 ? void 0 : config.custom_campaign_params,
        maskPersonalDataProperties: config === null || config === void 0 ? void 0 : config.mask_personal_data_properties,
        customPersonalDataProperties: config === null || config === void 0 ? void 0 : config.custom_personal_data_properties,
    }));
};
